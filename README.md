...
В разделе items мы делаем запрос на сервер с указанием сортировки и мин.цены. 
После запроса мы можем сортировать по цене, указывать мин.цену и искать по названию. Все манипуляции в блоке "Фильтры в загруженных данных" работают только на стороне фронта. 

В разделе "Поиск" идет простой безопасный запрос поиска по LIKE из-за чего он регистрозависим 